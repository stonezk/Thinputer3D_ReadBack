...
static D3D9Export g_swd3d9 = {0, "ThinputerD3D9-x86.dll", "MSD3D9.dll",};
#else
static D3D9Export g_swd3d9 = {0, "ThinputerD3D9.dll", "MSD3D9.dll",};
#endif
...
{
    //LogPrint("In d3d9.dll call the function %s",__FUNCTION__);
