...
!if $%VBOX_WITH_WDDM% == "1"
  ...
  !endif
    ...
    !if $%VBOX_WITH_CROGL% == "1"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLarrayspu.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLcrutil.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLerrorspu.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLpackspu.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLpassthroughspu.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGLfeedbackspu.dll"
      FILE "$%PATH_OUT%\bin\additions\ThinputerOGL.dll"
    ...
    !if $%BUILD_TARGET_ARCH% == "amd64"
      ...
      !if $%VBOX_WITH_CROGL% == "1"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLarrayspu-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLcrutil-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLerrorspu-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLpackspu-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLpassthroughspu-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGLfeedbackspu-x86.dll"
        FILE "$%PATH_OUT%\bin\additions\ThinputerOGL-x86.dll"
...
!if $%VBOX_WITH_CROGL% == "1"
  ...
  !endif
  StrCpy $0 "$TEMP\VBoxGuestAdditions\ThinputerOGL"
  CreateDirectory "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLarrayspu.dll"       "$g_strSystemDir\ThinputerOGLarrayspu.dll"       "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLcrutil.dll"         "$g_strSystemDir\ThinputerOGLcrutil.dll"         "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLerrorspu.dll"       "$g_strSystemDir\ThinputerOGLerrorspu.dll"       "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLpackspu.dll"        "$g_strSystemDir\ThinputerOGLpackspu.dll"        "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLpassthroughspu.dll" "$g_strSystemDir\ThinputerOGLpassthroughspu.dll" "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGLfeedbackspu.dll"    "$g_strSystemDir\ThinputerOGLfeedbackspu.dll"    "$0"
  !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%PATH_OUT%\bin\additions\ThinputerOGL.dll"               "$g_strSystemDir\ThinputerOGL.dll"               "$0"
  !if $%BUILD_TARGET_ARCH% == "amd64"
    !undef LIBRARY_X64 ; Disable installation of 64-bit libraries
  !endif

  !if $%BUILD_TARGET_ARCH% == "amd64"
    StrCpy $0 "$TEMP\VBoxGuestAdditions\ThinputerOGL32"
    CreateDirectory "$0"
    ...
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLarrayspu.dll"       "$SYSDIR\ThinputerOGLarrayspu.dll"       "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLcrutil.dll"         "$SYSDIR\ThinputerOGLcrutil.dll"         "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLerrorspu.dll"       "$SYSDIR\ThinputerOGLerrorspu.dll"       "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLpackspu.dll"        "$SYSDIR\ThinputerOGLpackspu.dll"        "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLpassthroughspu.dll" "$SYSDIR\ThinputerOGLpassthroughspu.dll" "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLfeedbackspu.dll"    "$SYSDIR\ThinputerOGLfeedbackspu.dll"    "$0"
    !insertmacro InstallLib DLL NOTSHARED REBOOT_PROTECTED "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGL.dll"               "$SYSDIR\ThinputerOGL.dll"               "$0"
...
cropengl:
  ...
  ${Else}
    ...
    WriteRegDWORD HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL" "Version" 2
    WriteRegDWORD HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL" "DriverVersion" 1
    WriteRegDWORD HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL" "Flags" 1
    WriteRegStr   HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL" "Dll" "ThinputerOGL.dll"
!if $%BUILD_TARGET_ARCH% == "amd64"
    SetRegView 32
...
!if $%VBOX_WITH_WDDM% == "1"
  ...
  Delete /REBOOTOK "$%PATH_OUT%\bin\additions\VBoxDispD3D.dll"
    ...
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLarrayspu.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLcrutil.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLerrorspu.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLpackspu.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLpassthroughspu.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLfeedbackspu.dll"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGL.dll"
  ...
  !if $%BUILD_TARGET_ARCH% == "amd64"
    Delete /REBOOTOK "$%PATH_OUT%\bin\additions\VBoxDispD3D-x86.dll"
      ...
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLarrayspu-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLcrutil-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLerrorspu-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLpackspu-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLpassthroughspu-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGLfeedbackspu-x86.dll"
      Delete /REBOOTOK "$%PATH_OUT%\bin\additions\ThinputerOGL-x86.dll"
...
!if $%VBOX_WITH_CROGL% == "1"
  ...
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLarrayspu.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLcrutil.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLerrorspu.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLpackspu.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLpassthroughspu.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGLfeedbackspu.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerOGL.dll"

  ; Remove D3D stuff
  ; @todo add a feature flag to only remove if installed explicitly
  Delete /REBOOTOK "$g_strSystemDir\libWine.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerD3D8.dll"
  Delete /REBOOTOK "$g_strSystemDir\ThinputerD3D9.dll"
  Delete /REBOOTOK "$g_strSystemDir\Thinputerd3d.dll"
  ; Update DLL cache
  ...
  !if $%BUILD_TARGET_ARCH% == "amd64"
    ...
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLarrayspu.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLcrutil.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLerrorspu.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLpackspu.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLpassthroughspu.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGLfeedbackspu.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerOGL.dll"

    ; Remove D3D stuff
    ; @todo add a feature flag to only remove if installed explicitly
    Delete /REBOOTOK "$g_strSysWow64\libWine.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerD3D8.dll"
    Delete /REBOOTOK "$g_strSysWow64\ThinputerD3D9.dll"
    Delete /REBOOTOK "$g_strSysWow64\Thinputerd3d.dll"
    ; Update DLL cache
    ...
    ${EndIf}
    DeleteRegKey HKLM "SOFTWARE\Wow6432Node\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL"
  !endif ; amd64

  DeleteRegKey HKLM "SOFTWARE\Microsoft\Windows NT\CurrentVersion\OpenGLDrivers\ThinputerOGL"
