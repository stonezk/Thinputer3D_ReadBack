...
!if $%VBOX_WITH_CROGL% == "1"
  ...
  FILE "$%PATH_OUT%\bin\additions\ThinputerD3D8.dll"
  FILE "$%PATH_OUT%\bin\additions\ThinputerD3D9.dll"
  FILE "$%PATH_OUT%\bin\additions\ThinputerWined3d.dll"
  ...
  !if $%BUILD_TARGET_ARCH% == "amd64"
    ...
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLarrayspu.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLcrutil.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLerrorspu.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLpackspu.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLpassthroughspu.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGLfeedbackspu.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerOGL.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerD3D8.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerD3D9.dll"
    FILE "$%VBOX_PATH_ADDITIONS_WIN_X86%\ThinputerWined3d.dll"
  !endif
!endif
