...
# NOTE: if we need a LIBRARY statement, we would need to create a defs-x86.py to generate a .def file for ThinputerOGL-x86 library
#print "LIBRARY ThinputerOGL"
