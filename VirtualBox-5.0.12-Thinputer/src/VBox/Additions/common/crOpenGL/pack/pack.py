...
pack_hooks = apiutil.GetHooksTable()
...
for index in range(len(keys)):
    ...
    if apiutil.FindSpecial( "packspu_unimplemented", func_name ):
        continue
    if func_name in pack_hooks:
        print '\t// hook func:'
        print '\t__fillin( %3d, "%s", (SPUGenericFunction) hook_packspu_%s );' % (index, func_name, func_name )
    elif func_name in pack_specials:
