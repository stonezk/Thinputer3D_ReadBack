...
#ifdef RT_ARCH_AMD64
        { szSysWowDir, "ThinputerOGLarrayspu.dll" },
        { szSysWowDir, "ThinputerOGLcrutil.dll" },
        { szSysWowDir, "ThinputerOGLerrorspu.dll" },
        { szSysWowDir, "ThinputerOGLpackspu.dll" },
        { szSysWowDir, "ThinputerOGLpassthroughspu.dll" },
        { szSysWowDir, "ThinputerOGLfeedbackspu.dll" },
        { szSysWowDir, "ThinputerOGL.dll" },
#else  /* !RT_ARCH_AMD64 */
# ifdef TARGET_NT4
        { szSysDir, "ThinputerOGLarrayspu.dll" },
        { szSysDir, "ThinputerOGLcrutil.dll" },
        { szSysDir, "ThinputerOGLerrorspu.dll" },
        { szSysDir, "ThinputerOGLpackspu.dll" },
        { szSysDir, "ThinputerOGLpassthroughspu.dll" },
        { szSysDir, "ThinputerOGLfeedbackspu.dll" },
        { szSysDir, "ThinputerOGL.dll" },
# endif
#endif /* !RT_ARCH_AMD64 */
