...
#define DEFAULT_SERVER_PORT 7050
//add szk
// int port_3D = 7050;
//char Terminal_ip[32];
 ...
 */
 //add szk
extern DECLEXPORT(void) SetIPAndPort(int port, char *ip);
extern DECLEXPORT(int) Get_Port_3D(int port, char *ip);
...
extern DECLEXPORT(void) crNetSend_VIO( CRConnection *conn, void **bufp, const void *start, unsigned int len );
